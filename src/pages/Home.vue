    ...
    <article>
        ...
        <div class="sidebar">
            ...
            <div class="links">
                ...
                <ul>
                    <li><a href="http://suhhai.cn/" target="_blank">SueSea博客</a></li>
                    <li><a href="http://suhhai.cn/" target="_blank">D设计师博客</a></li>
                    <li><a href="http://suhhai.cn/" target="_blank">优秀个人博客</a></li>
                </ul>
            </div>
            <div class="guanzhu" id="follow-us">
                <h2 class="hometitle">关注我们 么么哒！</h2>
                <ul>
                    <li class="sina"><a href="/" target="_blank"><span>新浪微博</span>SueSea博客</a></li>
                    <li class="tencent"><a href="/" target="_blank"><span>腾讯微博</span>SueSea博客</a></li>
                    <li class="qq"><a href="/" target="_blank"><span>QQ号</span>344593220</a></li>
                    <li class="email"><a href="/" target="_blank"><span>邮箱帐号</span>344593220@qq.com</a></li>
                    <li class="wxgzh"><a href="/" target="_blank"><span>微信号</span>suloveme1995</a></li>
